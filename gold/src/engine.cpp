...
static const std::unordered_map<uint32_t, sprite_params_t> SPRITE_PARAMS = {
    ...
    { SPRITE_GOLD_MINE, (sprite_params_t) {
        .path = "sprite/gold_mine.png",
        .hframes = 3,
        .vframes = 1,
...
static const std::unordered_map<Sound, sound_params_t> SOUND_PARAMS = {
    ...
    { SOUND_CANNON, (sound_params_t) {
        .path = "sfx/cannon",
        .variants = 4
    }},
    { SOUND_BUILDING_DESTROY, (sound_params_t) {
        .path = "sfx/building_destroy",
        .variants = 1
    }},
    { SOUND_BUNKER_DESTROY, (sound_params_t) {
        .path = "sfx/bunker_destroy",
        .variants = 1
    }},
    { SOUND_MINE_DESTROY, (sound_params_t) {
    ...
    { SOUND_ALERT_BELL, (sound_params_t) {
        .path = "sfx/alert_bell",
        .variants = 1
    }},
    { SOUND_ALERT_BUILDING, (sound_params_t) {
        .path = "sfx/alert_building",
        .variants = 1
    }},
    { SOUND_ALERT_RESEARCH, (sound_params_t) {
        .path = "sfx/alert_research",
        .variants = 1
    }},
...
const std::unordered_map<UiButton, SDL_Keycode> DEFAULT_HOTKEYS = {
    ...
    { UI_BUTTON_BUILD_BUNKER, SDLK_r },
    { UI_BUTTON_BUILD_COOP, SDLK_c },
    { UI_BUTTON_BUILD_SMITH, SDLK_b },
...
const std::unordered_map<UiButton, SDL_Keycode> GRID_HOTKEYS = {
    ...
    { UI_BUTTON_BUILD_SALOON, SDLK_w },
    { UI_BUTTON_BUILD_BUNKER, SDLK_a },
    { UI_BUTTON_BUILD_COOP, SDLK_q },
    { UI_BUTTON_BUILD_SMITH, SDLK_s },
    { UI_BUTTON_BUILD_BARRACKS, SDLK_w },
    { UI_BUTTON_BUILD_SHERIFFS, SDLK_e },
