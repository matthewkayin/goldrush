...
static const std::unordered_map<HotkeyGroupName, HotkeyGroup> HOTKEY_GROUPS = {
    ...
    { HOTKEY_GROUP_SMITH, (HotkeyGroup) {
        ...
        .hotkeys = { 
            INPUT_HOTKEY_RESEARCH_BLACK_POWDER, INPUT_HOTKEY_RESEARCH_SERRATED_KNIVES, INPUT_HOTKEY_RESEARCH_BAYONETS,
            INPUT_HOTKEY_RESEARCH_WAGON_ARMOR, INPUT_HOTKEY_NONE, INPUT_HOTKEY_NONE
        }
    }},
