...
static const std::unordered_map<FontName, FontParams> FONT_PARAMS = {
    { FONT_HACK_OFFBLACK, (FontParams) { 
        ...
        .path = "hack.ttf", 
        .size = 10,
        .r = 40, .g = 37, .b = 45, .a = 255
    }},
    { FONT_HACK_SHADOW, (FontParams) { 
        .options = FONT_OPTION_IGNORE_BEARING,
        .path = "hack.ttf", 
        .size = 10,
        .r = 40, .g = 37, .b = 45, .a = 200
    }},
