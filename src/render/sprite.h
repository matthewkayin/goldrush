...
enum SpriteName {
    ...
    SPRITE_UI_STAT_ICON_ATTACK,
    SPRITE_UI_STAT_ICON_MELEE_ATTACK,
    SPRITE_UI_STAT_ICON_DEFENSE,
    SPRITE_UI_STAT_ICON_ACCURACY,
    SPRITE_UI_STAT_ICON_EVASION,
    ...
    SPRITE_BUTTON_ICON_UPGRADE_ARMOR,
    SPRITE_BUTTON_ICON_UPGRADE_GUNS,
    SPRITE_BUTTON_ICON_LIGHT_ARMOR,
    SPRITE_BUTTON_ICON_HEAVY_ARMOR,
    SPRITE_BUTTON_ICON_BLACK_POWDER,
