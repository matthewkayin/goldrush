...
const uint32_t AUTOTILE_DIRECTION_MASK[DIRECTION_COUNT] = {
    1,
    2,
    4,
    8,
...
const uint32_t AUTOTILE_EDGE_MASK[4] = { 
    AUTOTILE_DIRECTION_MASK[DIRECTION_NORTH] + AUTOTILE_DIRECTION_MASK[DIRECTION_NORTHWEST] + AUTOTILE_DIRECTION_MASK[DIRECTION_WEST],
    AUTOTILE_DIRECTION_MASK[DIRECTION_NORTH] + AUTOTILE_DIRECTION_MASK[DIRECTION_NORTHEAST] + AUTOTILE_DIRECTION_MASK[DIRECTION_EAST],
    AUTOTILE_DIRECTION_MASK[DIRECTION_WEST] + AUTOTILE_DIRECTION_MASK[DIRECTION_SOUTHWEST] + AUTOTILE_DIRECTION_MASK[DIRECTION_SOUTH],
    AUTOTILE_DIRECTION_MASK[DIRECTION_EAST] + AUTOTILE_DIRECTION_MASK[DIRECTION_SOUTHEAST] + AUTOTILE_DIRECTION_MASK[DIRECTION_SOUTH]
};
