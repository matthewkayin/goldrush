...
enum InputAction {
    ...
    INPUT_HOTKEY_UPGRADE_ARMOR,
    INPUT_HOTKEY_UPGRADE_GUNS,
    INPUT_HOTKEY_RESEARCH_LIGHT_ARMOR,
    INPUT_HOTKEY_RESEARCH_HEAVY_ARMOR,
    INPUT_HOTKEY_RESEARCH_BLACK_POWDER,
