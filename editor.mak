...
# Make does not offer a recursive wildcard function, so here's one:
	...
	SRC_FILES += $(call rwildcard,editor/,*.cpp) # Get all .c files
	DIRECTORIES := .\editor $(subst $(DIR),,$(shell dir .\editor /S /AD /B | findstr /i editor)) # Get all directories under editor.
	...
	SRC_FILES += $(shell find editor -name *.cpp)
	DIRECTORIES := $(shell find vendor -type d)
	DIRECTORIES += $(shell find editor -type d)
endif
